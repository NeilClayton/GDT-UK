					...
					<div class="col-md-10 col-md-offset-1">
						...
						<div id="theory-content">
							...
							<div id="books" class="collapse">
								<h6>Recommended reading/books</h6>
							...
							<div id="booking" class="collapse">
								<h6>Book a driving theory test</h6>
